...
$this->title = 'Fulbright Science School System';
?>
...
<!--Edit for Body(Mission) Part-->            
            <div class="col-lg-4">
                ...
                <p>	Fulbright Science School is committed to giving quality education and values
...
<!--Edit for Body(Part 3) Part-->
                <p id="WhatItTakes">Knowing the requirements</p>
