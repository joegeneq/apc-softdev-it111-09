...
-- -----------------------------------------------------
-- Table `fullbright_aps`.`Comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fullbright_aps`.`Comment` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `fullbright_aps`.`Gallery`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fullbright_aps`.`Gallery` (
  `id` INT NOT NULL,
  `gallery_name` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
